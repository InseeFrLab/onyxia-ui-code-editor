...
const SCREEN_SCALER_GLOBAL_NAME: typeof OF_TYPE_SCREEN_SCALER_GLOBAL_NAME = "__screenScaler";

const GenericCodeEditorWithoutScreenScaler = lazy(() => import("./GenericCodeEditor"));
const GenericCodeEditorWithScreenScaler = lazy(() => import("./GenericCodeEditorWithScreenScaler"));
