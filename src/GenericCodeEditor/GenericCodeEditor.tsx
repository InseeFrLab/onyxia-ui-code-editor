import { CodeMirror, type Extension, createTheme, tags } from "../vendor/codemirror";
        ...
        () =>
            createTheme({
                ...
                settings: {
                    ...
                    selectionMatch: alpha(theme.colors.useCases.typography.textFocus, 0.3),
                    lineHighlight: alpha(theme.colors.useCases.typography.textFocus, 0.05),
